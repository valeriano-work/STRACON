...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.Plantilla
{
    ...
    public class PlantillaFormulario : GenericViewModel
    {
        ...
        public PlantillaFormulario(List<CodigoValorResponse> tipoServicio, List<CodigoValorResponse> tipoRequerimiento, List<CodigoValorResponse> tipoDocumentoContrato, List<CodigoValorResponse> estadoVigencia, string indicadorCopia)
        {
