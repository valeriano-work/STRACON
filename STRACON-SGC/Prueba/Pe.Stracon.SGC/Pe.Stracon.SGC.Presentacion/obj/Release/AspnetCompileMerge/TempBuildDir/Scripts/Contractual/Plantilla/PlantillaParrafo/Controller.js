...
Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Index.Controller = function () {
    var base = this;

    base.Configurations = {
        Llave: 'Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Index.Filtro'
    };

    base.Ini = function () {

        base.Control.PlantillaParrafo = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Models.Index;
        ...
        PlantillaParrafoModel = Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.Plantilla.PlantillaParrafoBusqueda.Model.PlantillaModel;
    ...
    base.Event = {
        ...
        BtnAgregarClick: function () {
            ...
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Actions.FormularioPlantillaParrafo + "?codigoPlantilla=" + base.Control.HdnCodigoPlantilla().val();
        },
        ...
        BtnGridEditClick: function (row, data) {
            ...
            Pe.GMD.UI.Web.Components.Storage.Set(base.Configurations.Llave, filtro);
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Actions.FormularioPlantillaParrafo + "?codigoPlantilla=" + data.CodigoPlantilla + "&codigoPlantillaParrafo=" + data.CodigoPlantillaParrafo;
        },
        ...
        BtnEliminarClick: function () {
            ...
            if (selectedData.length < 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.EtiquetaTituloAdvertencia,
                ...
                base.Control.Mensaje.Confirmation({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.TituloEliminar,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.ConfirmacionEliminacionRegistros,
                    onAccept: function () {
        ...
        BtnGridDeleteClick: function (row, data) {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.TituloEliminar,
                message: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.ConfirmacionEliminacionRegistro,
                onAccept: function () {
                    base.Ajax.AjaxEliminar.data = {
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Actions.EliminarPlantillaParrafo,
            autoSubmit: false,
            onSuccess: base.Event.AjaxEliminarSuccess
        }),
        AjaxValidarParrafoPorPlantilla: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Actions.BuscarPlantillaParrafo,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'Orden',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.GridOrden,
                width: "5%"
            });
            columns.push({
                data: 'Titulo',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Resources.GridDescripcion,
                width: "80%",
                'class': 'left'
            });
            columns.push({
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaParrafo.Actions.BuscarPlantillaParrafo,
                    source: 'Result'
                }
            });
        },
