...
Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Index.Controller = function () {
    var base = this;

    base.Configurations = {
        Llave: 'Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Index.Filtro'
    };

    base.Ini = function () {

        base.Control.PlantillaNotaPie = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Models.Index;
    ...
    base.Event = {
        ...
        BtnAgregarClick: function () {
            ...
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Actions.FormularioPlantillaNotaPie + "?codigoPlantilla=" + base.Control.HdnCodigoPlantilla().val();
        },
        ...
        BtnGridEditClick: function (row, data) {
            ...
            Pe.GMD.UI.Web.Components.Storage.Set(base.Configurations.Llave, filtro);
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Actions.FormularioPlantillaNotaPie + "?codigoPlantilla=" + data.CodigoPlantilla + "&codigoPlantillaNotaPie=" + data.CodigoPlantillaNotaPie;
        },
        ...
        BtnEliminarClick: function () {
            ...
            if (selectedData.length < 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.EtiquetaTituloAdvertencia,
                ...
                base.Control.Mensaje.Confirmation({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.TituloEliminar,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.ConfirmacionEliminacionRegistros,
                    onAccept: function () {
        ...
        BtnGridDeleteClick: function (row, data) {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.TituloEliminar,
                message: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.ConfirmacionEliminacionRegistro,
                onAccept: function () {
                    base.Ajax.AjaxEliminar.data = {
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Actions.EliminarNotas,
            autoSubmit: false,
            onSuccess: base.Event.AjaxEliminarSuccess
        }),
        AjaxValidarNotaPiePorPlantilla: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Actions.BuscarNotasPiePorPlantilla,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'Orden',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.GridOrden,
                width: "5%"
            });          
            columns.push({
                data: 'Titulo',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.GridDescripcion,
                width: "80%",
                'class': 'left'
            });
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Resources.GridAcciones,
                "class": "controls",
                width: "5%",
                actionButtons: [
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.Plantilla.PlantillaNotaPie.Actions.BuscarNotasPiePorPlantilla,
                    source: 'Result'
                }
            });
        },
