...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.Consulta.FormularioConsulta');
Pe.Stracon.SGC.Presentacion.Contractual.Consulta.FormularioConsulta.Controller = function (opts) {
    var base = this;
    ...
    base.Ini = function () {
        ...
        base.Control.Modelo = Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.Consulta.FormularioConsulta.Model.Modelo;

        if (base.Control.Modelo.IndicadorStaff == true) {
            base.Control.TfDestinatarioFormulario = new Pe.GMD.UI.Web.Components.TokenField({
                ...
                prePopulate: base.Function.AdaptarListaToken(Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.Consulta.FormularioConsulta.Model.ListaDestinatario)
            });
        }
    ...
    base.Control = {
        BtnGrabar: function () { return $('#btnFrmGrabarConsulta'); },
        BtnCancelar: function () { return $('#btnFrmCancelarConsulta'); },
        FrmConsulta: function () { return $('#frmConsulta'); },
        SlcFrmDestinatario: function () { return $('#slcFrmDestinatario'); },
        TxtDestinatario: function () { return $('#txtDestinatarioFormulario'); },
        SlcFrmTipoConsulta: function () { return $('#slcFrmTipoConsulta'); },
        SlcFrmUnidadOperativa: function () { return $('#slcFrmUnidadOperativaFormularioConsulta'); },
        SlcFrmArea: function () { return $('#slcFrmAreaFormularioConsulta'); },
        TxtAsunto: function () { return $('#txtAsunto'); },
        TxtContenido: function () { return $('#txtContenido'); },
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.Stracon.SGC.Presentacion.Contractual.Consulta.Resources.EtiquetaTituloConsulta
        }),
        ...
        //Adjuntos
        Controles: null,
        FileArchivoCargar: function () { return $('#MyFileConsulta'); },
        BtnAceptarFile: function () { return $('#btnAceptarCargaAdjuntoConsulta'); },
        TxtUploadFile: function () { return $('#uploadFileConsulta'); },
        GrdResultadoAdjunto: null,
        BtnTargetShow: null,
        ValidateExt: null,
        ExtensionFile: null,
        ArrayAdjuntos: new Array(),
        TblAdjuntos: function () { return $('#tblAdjuntos'); },
        Files: null,
        NumeroFile: 1,
        RutaFile: null,
        controlUpload: null
    ...
    base.Event = {
            ...
            if (base.Control.Validador.isValid()) {
                base.Control.Mensaje.Confirmation({
                    ...
                    onAccept: function () {
                        var codRemitente = "";
                        if (base.Control.Modelo.IndicadorStaff == true) {
                            codDestinatario = base.Control.TxtDestinatario().tokenInput("get")[0].id;
                        }else
                        {
                            codDestinatario = base.Control.SlcFrmDestinatario().val()
                        }

                        base.Ajax.AjaxGrabar.data = {
                            CodigoDestinatario: codDestinatario,
                            Tipo: base.Control.SlcFrmTipoConsulta().val().trim(),
                            Asunto: base.Control.TxtAsunto().val(),
                            Contenido: base.Control.TxtContenido().val(),
                            CodigoUnidadOperativa: base.Control.SlcFrmUnidadOperativa().val(),
                            CodigoArea: base.Control.SlcFrmArea().val(),
                            NombreArea: base.Control.SlcFrmArea().find("option:selected").text(),
                            DescripcionTipo: base.Control.SlcFrmTipoConsulta().find("option:selected").text(),
        ...
        BtnAceptarFileClick: function () {
            ...
            if (base.Control.TblAdjuntos().find('tr[data-bloqueo=0]').length >= 3) {
                base.Control.Mensaje.Warning({ title: base.Control.LblTitleModal, message: "Máximo número de archivos permitidos (3)." });
                return;
            } 

            //Otro método
            var txtFile = document.getElementById("MyFileConsulta");
    ...
    base.Show = function () {
        base.Control.DlgForm.getAjaxContent({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Consulta.Actions.FormularioConsulta,
            onSuccess: function () {
                base.Ini();
            },
        });
