...
Pe.Stracon.SGC.Presentacion.Contractual.ReporteListadoContrato.Index.Controller = function () {
    var base = this;
    base.Ini = function () {

        base.Control.ReporteListadoContratoModel = Pe.Stracon.SGC.Presentacion.Contractual.ReporteListadoContrato.Models.Index;
        ...
        if (base.Control.ReporteListadoContratoModel.ReporteListadoContrato.NombreTrabajadorResponsable != null) {
            base.Control.Trabajador.push({
                CodigoTrabajador: base.Control.ReporteListadoContratoModel.ReporteListadoContrato.CodigoTrabajadorResponsable,
                NombreCompleto: base.Control.ReporteListadoContratoModel.ReporteListadoContrato.NombreTrabajadorResponsable
            });
        }

        base.Control.TfEnBandejaDe = new Pe.GMD.UI.Web.Components.TokenField({
            data: Pe.Stracon.SGC.Presentacion.Contractual.ReporteListadoContrato.Actions.BuscarTrabajador,
