...
namespace Pe.Stracon.SGC.Infraestructura.CommandModel.Mapping.Contractual
{
    ...
    /// Modificación:            <br />
    /// </remarks>
    public class PlantillaMapping : BaseEntityMapping<PlantillaEntity>
    {
        /// <summary>
        ...
        public PlantillaMapping()
            :base()
        {
            HasKey(x => x.CodigoPlantilla).ToTable("PLANTILLA", "CTR");
            ...
            Property(u => u.CodigoTipoDocumentoContrato).HasColumnName("CODIGO_TIPO_DOCUMENTO");
