...
namespace Pe.Stracon.SGC.Aplicacion.Adapter.Contractual
{
    ...
    /// </summary>
    public class PlantillaParrafoVariableAdapter
    {
        /// <summary>
        ...
        public static PlantillaParrafoVariableResponse ObtenerPlantillaParrafoVariable(PlantillaParrafoVariableLogic plantillaParrafoVariableLogic)
        {
            var plantillaParrafoVariableResponse = new PlantillaParrafoVariableResponse();
        ...
        public static PlantillaParrafoVariableEntity RegistrarPlantillaParrafoVariable(PlantillaParrafoVariableRequest data)
        {
            var plantillaParrafoVariableEntity = new PlantillaParrafoVariableEntity();
