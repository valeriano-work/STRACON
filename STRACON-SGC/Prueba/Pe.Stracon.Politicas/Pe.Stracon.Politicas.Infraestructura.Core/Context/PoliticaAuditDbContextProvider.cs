...
namespace Pe.Stracon.Politicas.Infraestructura.Core.Context
{
    ...
    /// Modificación:            <br />
    /// </remarks>
    public class PoliticaAuditDbContextProvider : DbContext, IDbContextProvider
    {
        /// <summary>
        /// Constructor por defecto de implementación de la clase
        /// </summary>
        public PoliticaAuditDbContextProvider()
            : base("PoliticaAuditDbContextProvider")
        {
        ...
        {
            string assemblyName = ConfigurationManager.AppSettings["ModelAssembly"];
