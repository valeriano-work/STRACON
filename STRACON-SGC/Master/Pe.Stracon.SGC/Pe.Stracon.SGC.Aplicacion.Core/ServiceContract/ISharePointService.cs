...
namespace Pe.Stracon.SGC.Aplicacion.Core.ServiceContract
{
    public interface ISharePointService : IGenericService
    {
        ...
        /// </summary>
        /// <returns></returns>
        NetworkCredential RetornaCredencialesServer();
        ...
        /// <returns>Indicador con el resultado de la operación</returns>
        ProcessResult<Object> RegistraArchivoSharePoint(ref string hayError, string listName, string folderName, string fileName, MemoryStream myFile, string prmSiteURL = null, NetworkCredential prmCredenciales = null);
