...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ArchivoAdjuntoContrato
{
    /// <summary>
    ...
    /// Modificación:            <br />
    /// </remarks>
    public class ArchivoAdjuntoContratoFormulario
    {
        /// <summary>
        /// Contructor de la clase
        /// </summary>
        public ArchivoAdjuntoContratoFormulario()
        {
