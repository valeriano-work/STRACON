...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ReporteContratoEliminado
{
    /// <summary>
    /// Modelo de vista para el Reporte Contrato Eliminado
    /// </summary>
    /// <remarks>
    /// Creación:       GMD 20170627 </br>
    /// Modificación:                </br>
    /// </remarks>
    public class ReporteContratoEliminadoBusqueda: GenericViewModel
    {
        /// <summary>
        ...
        public ReporteContratoEliminadoBusqueda(List<UnidadOperativaResponse> unidadOperativa, List<CodigoValorResponse> tipoServicio, List<CodigoValorResponse> tipoRequerimiento, List<CodigoValorResponse> tipoDocumento, List<CodigoValorResponse> estadoContrato, ReporteListadoContratoResponse reporteListadoContrato)
        {
