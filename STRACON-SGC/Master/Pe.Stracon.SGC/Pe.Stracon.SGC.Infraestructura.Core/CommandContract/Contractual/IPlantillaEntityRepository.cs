...
namespace Pe.Stracon.SGC.Infraestructura.Core.CommandContract.Contractual
{
    ...
    public interface IPlantillaEntityRepository : IComandRepository<PlantillaEntity>
    {
        ...
        /// <returns></returns>
        int CopiarPlantilla(Guid codigoPlantillaCopiar, string descripcion, string codigoTipoContrato, string codigoTipoDocumento, DateTime fechaInicioVigencia, string usuarioCreacion, string terminalCreacion);
    }
}
