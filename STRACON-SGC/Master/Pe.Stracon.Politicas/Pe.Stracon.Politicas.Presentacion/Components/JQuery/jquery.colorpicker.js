...
;(function ($) {
	...
	$.colorpicker = new function() {
		this.regional = {
			'':	{
				ok:				'OK',
				cancel:         Yanbal.PYF.Web.Shared.General.Resources.EtiquetaCancelarConfirmacion,
				none:           Yanbal.PYF.Web.Shared.General.Resources.EtiquetaNinguno,
				button:			'Color',
				title:          Yanbal.PYF.Web.Shared.General.Resources.EtiquetaElijaColor,
				transparent:    Yanbal.PYF.Web.Shared.General.Resources.EtiquetaTransparente,
				hsvH:			'H',
				hsvS:			'S',
				hsvV:			'V',
				rgbR:			'R',
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:		'/Scripts/JQuery/images/ui-colorpicker.png',
