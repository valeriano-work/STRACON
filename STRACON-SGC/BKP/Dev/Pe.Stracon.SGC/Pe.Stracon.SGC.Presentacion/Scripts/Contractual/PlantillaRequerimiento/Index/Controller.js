...
Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Index.Controller = function () {
    var base = this;
         base.Configurations = {
         Llave: 'Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Index.Filtro'
    };

    base.Ini = function () {
        base.Control.PlantillaModel = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Models.Index;
        'use strict'
        ...
        base.Control.DlgFormularioPlantilla = new Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantilla.Controller({
    ...
    base.Control = {
        PlantillaRequerimientoModel: null,
    ...
    base.Event = {
        ...
        BtnGridDeleteClick: function (row, data) {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.TituloEliminar,
                message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.ConfirmacionEliminacionRegistro,
                onAccept: function () {
        ...
        BtnGridCopiarPlantillaClick: function (row, data) {
            'use strict'
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.TituloCopiarPlantilla,
                message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.ConfirmacionCopiarPlantilla,
                onAccept: function () {
        ...
        AjaxValidarParrafoPorPlantillaSuccess: function (data) {
            ...
            if (data.Result.length >= 1) {
                Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.GenerarVistaPreviaPlantilla, param);
            }
            else {
        ...
        BtnEliminarClick: function () {
            ...
            if (selectedData.length < 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.EtiquetaTituloAdvertencia,
                ...
                base.Control.Mensaje.Confirmation({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.TituloEliminar,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.ConfirmacionEliminacionRegistros,
                    onAccept: function () {
                        base.Ajax.AjaxEliminar.data = {
        ...
        BtnGridParrafoClick: function (row, data) {
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.PlantillaParrafo + "?codigoPlantilla=" + data.CodigoPlantilla;
        },
        ...
        BtnGridNotaPieClick: function (row, data) {
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.PlantillaNotaPie + "?codigoPlantilla=" + data.CodigoPlantilla;
        },
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.EliminarPlantilla,
            autoSubmit: false,
            onSuccess: base.Event.AjaxEliminarSuccess
        }),
        AjaxValidarParrafoPorPlantilla: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.BuscarPlantillaParrafo,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'Descripcion',
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridDescripcion,
                width: "30%"
            });
            columns.push({
                data: 'IndicadorAdhesion',
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridAdhesion,
                width: "15%",
                mRender: function (data, type, full) {
                    var texto = '';
                    if (full.IndicadorAdhesion == true) {
                        texto = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridSi;
                    } else {
                        texto = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridNo;
                    }
                    return texto;
                }
            });
            columns.push({
                ...
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridVigente,
                width: "15%"
            });
            columns.push({
                data: 'FechaInicioVigenciaString',
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridInicioVigencia,
                width: "15%"
            });
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridParrafos,
                "class": "controls",
                actionButtons: [
            ...
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridNotasPie,
                "class": "controls",
                actionButtons: [
            ...
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Resources.GridAcciones,
                "class": "controls",
                width: "10%",
                actionButtons: [
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.Actions.BuscarPlantilla,
                    source: 'Result'
                }
            });
        }
