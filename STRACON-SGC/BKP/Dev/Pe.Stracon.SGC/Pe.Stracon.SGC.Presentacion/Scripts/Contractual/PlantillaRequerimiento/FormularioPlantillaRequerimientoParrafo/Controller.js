...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Index');
Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Index.Controller = function (opts) {
    var base = this;
    ...
    base.Event = {
        ...
        BtnCancelarClick: function () {
            'use strict'
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Actions.PlantillaParrafo + "?codigoPlantilla=" + base.Control.HdnCodigoPlantilla().val();
        },
        ...
        AjaxGrabarSuccess: function (data) {
            ...
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Actions.PlantillaParrafo + "?codigoPlantilla=" + data.Result.CodigoPlantilla;
        },
        ...
        BtnGrabarClick: function () {
            ...
            if (base.Control.SpnFrmOrden().val() == 0 || base.Control.SpnFrmOrden().val() == "" || base.Control.SpnFrmOrden().val() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Resources.EtiquetaFormularioPlantillaParrafo,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Mensajes.MsjValidaOrdenParrafo
                });
                return;
            }
            ...
            if (base.Control.TxtFrmTitulo().val() == "" || base.Control.TxtFrmTitulo().val() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Resources.EtiquetaFormularioPlantillaParrafo,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Mensajes.MsjValidaTituloParrafo
                });
                return;
            }
            ...
            if (EditorContenido.getData() == "" || EditorContenido.getData() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Resources.EtiquetaFormularioPlantillaParrafo,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Mensajes.MsjValidaContenidoParrafo
                });
                return;
            }

            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Resources.EtiquetaTituloConfirmar,
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Actions.RegistrarPlantillaParrafo,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({ data: 'Nombre', title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Resources.GridAtributos, width: "70%", 'class': 'left' });
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoParrafo.Actions.BuscarVariableGlobal,
                    source: 'Result'
                }
            });
        },
