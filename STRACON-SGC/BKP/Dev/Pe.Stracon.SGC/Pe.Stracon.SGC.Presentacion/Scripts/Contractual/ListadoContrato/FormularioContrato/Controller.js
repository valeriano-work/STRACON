...
Pe.Stracon.SGC.Presentacion.Contractual.ListadoContrato.FormularioContrato.Controller = function (opts) {
    ...
    base.Ini = function () {
        ...
        //    queryParam: "filtroReq", searchingText: 'Buscando Trabajador..', resultsLimit: 1,
        //    noResultsText: 'Trabajador No Encontrado..', hintText: 'Digite Nombre del Trabajador',
        //    propertyToSearch: 'NombreCompleto', tokenValue: 'CodigoTrabajador',
        //    prePopulate: base.Function.AdaptarListaToken(Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ListadoContrato.ContratoFormulario.Model.ListaRequerido)         
        //});
        ...
        base.Control.TfRequerido = new Pe.GMD.UI.Web.Components.TokenField({
            ...
            hintText: 'Digite nombre del usuario quien requierió el servicio',
