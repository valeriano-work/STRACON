...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafo');
Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafo.Controller = function (opts) {
    var base = this;
    var t;
    base.Ini = function () {
        ...
        base.Control.PlantillaContratoParrafoModel = Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafo.Models.FormularioContratoParrafo;
        ...
        base.Control.DlgFormularioContratoParrafoTabla = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafoTabla.Controller({

            AceptarSuccess: base.Event.ReemplazarTabla
        });

        base.Control.DlgFormularioContratoParrafoBien = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafoBien.Controller({
            AceptarSuccess: base.Event.ReemplazarTabla
        });

        base.Control.DlgFormularioContratoParrafoFirmante = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafoFirmante.Controller({
    ...
    base.Event = {
        ...
        BtnVistaPreviaClick: function () {
            ...
            Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.GenerarVistaPreviaContrato, data);
        }
    };

    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.RegistrarContrato,
            autoSubmit: false,
    ...
    base.Show = function (data) {
        ...
        base.Control.DlgForm.getAjaxContent({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.FormularioContratoParrafo,
            onSuccess: function () {
                base.Ini();
            },
            data: {
