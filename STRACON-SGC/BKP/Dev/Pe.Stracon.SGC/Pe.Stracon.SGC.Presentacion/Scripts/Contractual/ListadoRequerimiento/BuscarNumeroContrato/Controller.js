...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.BuscarNumeroContrato');

Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.BuscarNumeroContrato.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        ...
        base.Control.DlgCopiaContrato = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioCopiaContrato.Controller({
    ...
    base.Ajax = {
        AjaxBuscarContrato: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.ObtenerContrato,
            autoSubmit: false,
