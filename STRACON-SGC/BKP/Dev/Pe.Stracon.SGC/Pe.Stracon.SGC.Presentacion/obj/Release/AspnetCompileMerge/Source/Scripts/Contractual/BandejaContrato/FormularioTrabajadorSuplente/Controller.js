...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.BandejaContrato.FormularioTrabajadorSuplente');
Pe.Stracon.SGC.Presentacion.Contractual.BandejaContrato.FormularioTrabajadorSuplente.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        'use strict'
        ...
        base.Control.TxtFechaFin().val(Pe.Stracon.SGC.Presentacion.Contractual.FormularioTrabajadorSuplente.Model.TrabajadorSuplente.FechaFinString);
        ...
        base.Control.DlgForm.setTitle(Pe.Stracon.SGC.Presentacion.Contractual.BandejaContrato.Resources.EtiquetaTituloPrincipalSuplente + " " + base.Control.HdnNombreTrabajador().val());
        ...
        base.Control.TfSuplente = new Pe.GMD.UI.Web.Components.TokenField({
            ...
            prePopulate: base.Function.AdaptarListaToken(Pe.Stracon.SGC.Presentacion.Contractual.FormularioTrabajadorSuplente.Model.ListaSuplente)
        });
    ...
    base.Control = {
        ...
        DlgForm: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.Stracon.SGC.Presentacion.Contractual.BandejaContrato.Resources.EtiquetaTituloPrincipalSuplente
        }),
        ...
        BtnGrabarClick: function () {
            ...
            if (base.Control.TxtSuplente().tokenInput("get").length == 0) {
                base.Control.DlgFormularioGrabar.Error({
                    ...
                    message: Pe.Stracon.SGC.Presentacion.Recursos.Validacion.MensajeErrorSuplente
                });
                return;
            }
