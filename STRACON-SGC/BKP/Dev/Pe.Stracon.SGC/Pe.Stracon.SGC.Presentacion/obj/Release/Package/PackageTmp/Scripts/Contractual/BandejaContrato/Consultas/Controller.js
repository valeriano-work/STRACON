...
Pe.Stracon.SGC.Presentacion.Contractual.BandejaContrato.Consultas.Controller = function () {
    var base = this;
    base.Ini = function () {
    ...
    base.Control = {
        ...
        TxtContratoEstadio: function () { return $('#hContratoEstadioConsulta'); },
        TxtCodigoContrato: function () { return $('#hCodigoContratoConsulta'); },
        TxtCodigoFlujoAprobacion: function () { return $('#hCodigoFlujoAprobacionConsulta'); }
    };
    ...
    base.Event = {
        ...
        BtnGridVerConsultaClick: function (row, data) {
            base.Control.DlgFormularioResponderConsulta.Show(data.CodigoContratoEstadioConsulta, data.CodigoContrato, "C");//Consultar
        },
        BtnGridResponderClick: function (row, data) {
            base.Control.DlgFormularioResponderConsulta.Show(data.CodigoContratoEstadioConsulta, data.CodigoContrato, "E");
        },
