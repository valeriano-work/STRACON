...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.FormularioSolicitudRevisionContratoAprobar');
Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.FormularioSolicitudRevisionContratoAprobar.Controller = function (opts) {
    var base = this;
    ...
    base.Ini = function () {
       ...
       // $('#frmPdfModificado').html(base.Control.HContenidoModificado().val());
        ...
        base.Control.FormularioContratoRechazar = new Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.FormularioRevisionRechazar.Controller({
    ...
    base.Show = function (codigoContrato) {
        base.Control.DlgFormContrato.getAjaxContent({
            action: Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.Actions.FormularioSolicitudRevisionContratoAprobar,
    ...
    base.Control = {
        ...
        DlgFormContrato: new Pe.GMD.UI.Web.Components.Dialog({
            title: Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.Resources.EtiquetaFormularioContrato,
            width: '80%'
        }),
    };
    ...
    base.Event = {
        ...
        BtnAprobarClick: function () {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.Resources.EtiquetaTituloConfirmar,
                message: Pe.Stracon.SGC.Presentacion.Recursos.Validacion.ConfirmacionAprobar,
                onAccept: function () {
                    base.Event.ProcesaEdicion(Pe.Stracon.SGC.Presentacion.Contractual.SolicitudRevisionContrato.Resources.CodigoRevisionAprobada);
                }
            });
        },
