...
using Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ListadoContrato;
...
namespace Pe.Stracon.SGC.Presentacion.Core.Controllers.Contractual
{
    ...
    /// </summary>
    /// <remarks>
    /// Creación:       GMD 20150601
    /// Modificación:
    /// </remarks>
    public class ListadoContratoController : GenericController
    {
        #region Parámetros
        /// <summary>
        ...
        /// <summary>
        /// Servicio de información de contrato
        /// </summary>
        ...
        public ActionResult Index()
        {
            ...
            var modelo = new ListadoContratoBusqueda(tipoServicio, tipoDocumento, estadoContrato, listaUnidadOperativa, estadoEdicion);
            ...
            modelo.ControlPermisos = Utilitario.ObtenerControlPermisos(HttpGyMSessionContext.CurrentAccount(), "/Contractual/ListadoContrato/");
        ...
        public ActionResult FormularioContrato(string codigoContrato, string valorEdicion)
        {
            ...
            {
                ContratoResponse contrato = contratoService.RetornaContratoPorId(new Guid(codigoContrato)).Result;
                ...
                modelo.TipoServicio = tipoServicio.FindAll(p => p.Codigo.ToString() == modelo.Contrato.CodigoTipoServicio.ToString()).Select(item => new SelectListItem() { Text = item.Valor.ToString(), Value = item.Codigo.ToString() }).ToList();
            ...
            else
            {
                ...
                modelo = new ContratoFormulario(tipoServicio, tipoDocumento, moneda, listaUnidadOperativa);
        ...
        public ActionResult FormularioContratoParrafo(string codigoContrato)
        {
            ...
            //#region Valida si es copia o original
            ////Obteniendo objeto contrato
            //var contrato = contratoService.ObtieneContratoPorID(new Guid(codigoContrato)).Result;

            //if (contrato.CodigoContratoOriginal != null)
            //{
            //    esCopia = true;
            //    var parrafos = contratoService.RetornaParrafosPorContrato(new Guid(contrato.CodigoContratoOriginal.ToString()));
            //}
            ...
            if (contrato.CodigoContratoOriginal != null)
            {
                var parrafos = contratoService.RetornaParrafosPorContrato(new Guid(codigoContrato));

                if (parrafos.Result.Count == 0)
                {
                    esCopia = true;
                    contrato = contratoService.ObtieneContratoPorID((Guid)contrato.CodigoContratoOriginal).Result;
                }
            }
            ...
            {
                CodigoContrato = contrato.CodigoContrato.ToString()
            }).Result.FirstOrDefault();

            var datoContratoCopia = new ListadoContratoResponse();

            var monedaDescripcion = "";
            var monedaPoliticas = politicaService.ListarMoneda().Result.OrderBy(x => x.Valor).ToList();
            if (esCopia)
            {
                datoContratoCopia = contratoService.BuscarListadoContrato(new ListadoContratoRequest()
                {
            ...
            variablePorDefecto.CodigoContratoPrincipal = datoContrato.CodigoContratoPrincipal.ToString();
            ...
            if (esCopia)
            {
                ...
                variablePorDefecto.MontoContratoString = datoContratoCopia.MontoContrato.ToString();
            ...
            else
            {
                ...
                variablePorDefecto.MontoContratoString = datoContrato.MontoContrato.ToString();
            ...
            if (contrato != null)
            {
                plantillaFiltro.CodigoTipoContrato = contrato.CodigoTipoServicio;
            ...
            if (resultadoPlantilla != null)
            {
                ...
                var listaValoresVariablesParrafo = contratoService.ObtenerVariablesContratoParrafo(contrato.CodigoContrato.ToString()).Result;
                ...
                if (esCopia)
                {
                    ...
                    if (montoTotal != null)
                    {
                        montoTotal.ValorTexto = datoContratoCopia.MontoContrato.ToString();
                    }
                    ...
                    foreach (var item in listaValoresVariablesParrafo)
                    {
                        switch (item.Identificador)
                        {
                            ...
                            case DatosConstantes.IdentificadorVariableDefecto.MontoContrato:
                                item.ValorTexto = datoContratoCopia.MontoContrato.ToString();
                                break;
                        }
                    }
                }
                    ...
                    foreach (var item in listaValoresVariablesParrafo)
                    {
                        switch (item.Identificador)
                        {
                            ...
                            case DatosConstantes.IdentificadorVariableDefecto.MonedaContrato:
                                ...
                                break;
                            case DatosConstantes.IdentificadorVariableDefecto.MontoContrato:
                                item.ValorTexto = datoContrato.MontoContrato.ToString();
                                break;
                        }
                    }
                }
        ...
        public ActionResult FormularioContratoParrafoBien()
        {
            ...
            //modelo = new ContratoParrafoBienFormulario(new List<BienResponse>());

            //INICIO: Agregado por Julio Carrera - Norma Contable

            //var contrato = contratoService.ObtieneContratoPorID(new Guid(codigoContrato)).Result;
            //modelo. = contrato.CodigoTipoServicio;

            //var model = TempData["CodigoTipoRequerimiento"];
            ...
            //H Por Hora
            //O Por hora
            //SelectListItem tipoPeriodo;
            //tipoPeriodo = new SelectListItem();
            //tipoPeriodo.Value = "M";
            //tipoPeriodo.Text = "Por Mes";
            //sliTipoPeriodo.Add(tipoTarifa);
            //tipoPeriodo = new SelectListItem();
            //tipoPeriodo.Value = "H";
            //tipoPeriodo.Text = "Por Hora";
            //sliTipoPeriodo.Add(tipoTarifa);


            //var lstTipoTarifa = new BienesController().retornaTipoTarifaBien();
            //List<SelectListItem> sliTipoTarifa = lstTipoTarifa.Select(i => new SelectListItem()
            //{
        ...
        public ActionResult FormularioContratoEditar(string codigoContrato)
        {
            ...
            var contrato = contratoService.RetornaContratoPorId(new Guid(codigoContrato));
            var doctos = contratoService.DocumentosPorContrato(new Guid(codigoContrato));
        ...
        public ActionResult GenerarVistaPreviaContrato(string contenido, string nombreDocumento, string codigoContrato)
        {
            ...
            {
                contrato = contratoService.ObtieneContratoPorID(new Guid(codigoContrato)).Result;
            ...
            if (contrato.CodigoTipoDocumento == Pe.Stracon.SGC.Infraestructura.Core.Context.DatosConstantes.TipoDocumento.Contrato)
            {
                contenidoContrato = contratoService.GenerarPdfDesdeHtml(contenido,
                                                                        ...
                                                                        (contrato != null ? contrato.CodigoContrato : null),
        ...
        public ActionResult FormularioContratoFlexibleCopiar(string codigoContrato)
        {
            ...
            ViewBag.Contenido = contenido;
            ViewBag.RespuestaAuto = rptaAuto;
            ViewBag.NumeroContrato = contrato.Result.NumeroContrato;
            return PartialView();
        }
        /// <summary>
        ...
        public JsonResult BuscarContrato(ListadoContratoRequest filtro)
        {
            ...
            var resultado = contratoService.BuscarListadoContratoOrden(filtro);
            var jsonResult = Json(resultado, JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
        ...
        /// <param name="filtro">Filtro de Búsqueda</param>
        /// <returns>Lista de Contratos</returns>
        public JsonResult BuscarContratoPorNumero(ListadoContratoRequest filtro)
        {
            ...
            var resultado = contratoService.BuscarContrato(filtro);
        ...
        {
            var resultado = contratoService.ObtenerMontoAcumuladoContrato(codigoContratoPrincipal);
            return Json(resultado);
        }
        ...
        public JsonResult BuscarUnidadOperativa(string codigoUnidadOperativa)
        {
            ...
            var lista_filtrada = contratoService.Obtener_Tipo_Contrato(variable);
        ...
        public JsonResult BuscarPlantillaFlujoAprobacion(PlantillaRequest plantilla, FlujoAprobacionRequest flujoAprobacion, string codigoMoneda, string montoContratoString, string montoAcumuladoString)
        {
            ...
            else if ((resultadoFlujoAprobacion != null || resultadoFlujoAprobacion.Count != 0))
            {
                ...
                var count = listaFlujoEstadio.Result.Count(item => item.IndicadorVersionOficial == true);
        ...
        public JsonResult RegistrarContrato(ContratoRequest request)
        {
            var resultado = contratoService.RegistrarListadoContrato(request);
        ...
        /// <returns>Indicador con el resultado de la operación</returns>
        [AuthorizeEscrituraFilter]
        public JsonResult RegistrarContratoGeneral(ContratoRequest request)
        {
            var resultado = contratoService.RegistrarContrato(request);
            return Json(resultado);
        }
        ...
        /// <returns>Indicador con el resultado de la operación</returns>
        [AuthorizeEscrituraFilter]
        public JsonResult RegistrarCopiaContrato(ContratoRequest request)
        {
            var resultado = contratoService.RegistrarCopiaContrato(request);
            return Json(resultado, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult ListarContratoPrincipal(ListadoContratoRequest filtro)
        {
            var resultado = contratoService.ListadoContratoPrincipal(filtro);
            return Json(resultado);
        }
        ...
        /// <returns>Indicador con el resultado de la operación</returns>
        [AuthorizeEscrituraFilter]
        public JsonResult RegistrarRespuestaAutorizador(ContratoRequest objRqst)
        {
        ...
        /// <returns>Indicador con el resultado de la operación</returns>
        [AuthorizeEscrituraFilter]
        public JsonResult RegistrarRespuestaGrabarAutorizador(ContratoRequest objRqst)
        {
            var result = contratoService.RegistrarRespuestaGrabarContrato(objRqst);
            return Json(result);
        }
        ...
        public JsonResult EliminarContrato(ListadoContratoRequest contrato)
        {
            var resultado = contratoService.EliminarContrato(contrato);
            return Json(resultado);
        }
        ...
        public JsonResult RegistrarContratoAdhesion()
        {
            ...
            var resultado = contratoService.RegistrarListadoContratoAdhesion(new ContratoRequest()
            {
                CodigoContrato = codigoContrato,
                ContratoDocumento = new ContratoDocumentoRequest()
                {
