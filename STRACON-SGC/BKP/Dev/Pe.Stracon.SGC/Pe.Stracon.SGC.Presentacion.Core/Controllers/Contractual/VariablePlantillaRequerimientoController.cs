...
using Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.VariablePlantillaRequerimiento;
using System;
...
namespace Pe.Stracon.SGC.Presentacion.Core.Controllers.Contractual
{
    ...
    /// Modificación:
    /// </remarks>
    public class VariablePlantillaRequerimientoController : GenericController
    {
        #region Parámetros
        /// <summary>
        ...
        {
            var plantilla = plantillarequerimientoService.BuscarPlantilla(new PlantillaRequerimientoRequest() { }).Result;
            var tipoVariable = variableService.ListarTipoVariable().Result;
            var modelo = new VariablePlantillaRequerimientoBusqueda(plantilla, tipoVariable);

            modelo.ControlPermisos = Utilitario.ObtenerControlPermisos(HttpGyMSessionContext.CurrentAccount(), "/Contractual/VariablePlantillaRequerimiento/");
        ...
        public ActionResult VariablePlantillaRequerimientoCampo(string CodigoVariablePlantilla)
        {
            var listaVariable = variableService.BuscarVariable(new VariableRequest() { CodigoVariable = CodigoVariablePlantilla }).Result;
            var modelo = new VariablePlantillaRequerimientoCampoBusqueda(listaVariable.FirstOrDefault());
        ...
        public ActionResult FormularioVariablePlantillaRequerimiento(string codigoVariable)
        {
            var plantilla = plantillarequerimientoService.BuscarPlantilla(new PlantillaRequerimientoRequest() { }).Result;
            var tipoVariable = variableService.ListarTipoVariable().Result;
            VariablePlantillaRequerimientoFormulario modelo = null;
            ...
            if (!string.IsNullOrWhiteSpace(codigoVariable))
            {
                ...
                if (variable != null)
                {
                    modelo = new VariablePlantillaRequerimientoFormulario(plantilla, variable, tipoVariable);
                }
                else
                {
                    modelo = new VariablePlantillaRequerimientoFormulario(plantilla, tipoVariable);
                }
            }
            else
            {
        ...
        public ActionResult FormularioVariablePlantillaRequerimientoCampo(VariableCampoRequest filtro)
        {
            VariablePlantillaRequerimientoCampoFormulario modelo = null;
            ...
            if (filtro != null && filtro.CodigoVariableCampo != null && filtro.CodigoVariableCampo != "" && filtro.CodigoVariableCampo != "00000000-0000-0000-0000-000000000000")
            {
                ...
                modelo = new VariablePlantillaRequerimientoCampoFormulario(listaCampos.FirstOrDefault(), listaTipoAlineamiento);
            }
            else
            {
                modelo = new VariablePlantillaRequerimientoCampoFormulario(filtro.CodigoVariable, listaTipoAlineamiento);
            }
        ...
        /// <returns>Vista Parcial de formulario de campos de variable</returns>
        public ActionResult FormularioVariablePlantillaRequerimientoLista(VariableListaRequest filtro)
        {
            VariablePlantillaRequerimientoListaFormulario modelo = null;
            ...
            if (filtro != null && filtro.CodigoVariableLista != null && filtro.CodigoVariableLista != "" && filtro.CodigoVariableLista != "00000000-0000-0000-0000-000000000000")
            {
                ...
                modelo = new VariablePlantillaRequerimientoListaFormulario(listaOpciones.FirstOrDefault());
            }
            else
            {
                modelo = new VariablePlantillaRequerimientoListaFormulario(filtro.CodigoVariable);
            }
        ...
        public JsonResult BuscarBandeVariablePlantillaRequerimiento(VariableRequest filtro)
        {
        ...
        public JsonResult RegistrarVariablePlantillaRequerimiento(VariableRequest data)
        {
        ...
        public JsonResult EliminarVariablePlantillaRequerimiento(List<Object> listaCodigoVariable)
        {
        ...
        /// </summary>
        /// <param name="listaCodigos">Lista de lista a eliminar</param>
        /// <returns>Código de resultado</returns>
