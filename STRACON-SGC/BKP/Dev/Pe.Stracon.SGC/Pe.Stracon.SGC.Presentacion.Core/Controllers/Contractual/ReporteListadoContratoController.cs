...
using Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ReporteListadoContrato;
...
namespace Pe.Stracon.SGC.Presentacion.Core.Controllers.Contractual
{
    ...
    /// Modificación:
    /// </remarks>
    public class ReporteListadoContratoController : GenericController
    {
        #region Parámetros
        /// <summary>
        ...
        public ActionResult Index(ReporteListadoContratoRequest filtro)
        {
            if (filtro != null)
            {
            ...
            var modelo = new ReporteListadoContratoBusqueda(unidadOperativa.Result, tipoServicio, tipoRequerimiento, tipoDocumento, estadoContrato, reporteListadoContrato);
        ...
        private ReporteViewModel CrearModelo(ReporteListadoContratoRequest filtro)
        {
