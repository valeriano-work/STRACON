...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ListadoRequerimiento
{
    ...
    public class ContratoParrafoFormulario : GenericViewModel
    {
        ...
        {
            this.ContratoParrafo = new RequerimientoResponse();
        }
        ...
        public ContratoParrafoFormulario(List<PlantillaParrafoResponse> plantillaParrafo, List<PlantillaParrafoVariableResponse> plantillaParrafoVariable, List<CodigoValorResponse> listaVariablePorDefecto, List<RequerimientoParrafoVariableResponse> listaValoresVariableParrafo, string intervaloTiempoAutoguardado)
        {
        ...
        /// </summary>
        public RequerimientoResponse ContratoParrafo { get; set; }
        /// <summary>
        ...
        /// </summary>
        public List<RequerimientoParrafoVariableResponse> ListaValoresVariableParrafo { get; set; }
        /// <summary>
