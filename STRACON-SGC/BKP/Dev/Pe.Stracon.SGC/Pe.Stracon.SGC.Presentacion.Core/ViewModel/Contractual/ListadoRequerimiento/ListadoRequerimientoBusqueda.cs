...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ListadoRequerimiento
{
    ...
    /// </summary>
    /// <remarks>
    /// Creación:       QUALIS 20191015    </br>
    /// Modificación:                   </br>
    /// </remarks>
    public class ListadoRequerimientoBusqueda : GenericViewModel
    {
        /// <summary>
        ...
        public ListadoRequerimientoBusqueda(List<CodigoValorResponse> tipoServicio, List<CodigoValorResponse> tipoDocumento, List<CodigoValorResponse> estadoContrato, List<SelectListItem> listaUnidadOperativa, List<CodigoValorResponse> estadoEdicion)
        {
