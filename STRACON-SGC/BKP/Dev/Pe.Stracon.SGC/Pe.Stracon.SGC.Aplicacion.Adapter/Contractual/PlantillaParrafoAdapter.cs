...
namespace Pe.Stracon.SGC.Aplicacion.Adapter.Contractual
{
    ...
    /// </summary>
    public class PlantillaParrafoAdapter
    {
        /// <summary>
        ...
        public static PlantillaParrafoResponse ObtenerPlantillaParrafoPaginado(PlantillaParrafoLogic plantillaParrafoLogic)
        {
            var plantillaParrafoResponse = new PlantillaParrafoResponse();
        ...
        public static PlantillaParrafoEntity RegistrarPlantillaParrafo(PlantillaParrafoRequest data)
        {
            var plantillaParrafoEntity = new PlantillaParrafoEntity();
