...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.Index');

Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.Index.Controller = function () {
    var base = this;

    base.Ini = function () {
        'use strict'
        base.Control.ListadoContratoModel = Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.Models.Index;
        ...
        base.Control.DlgFormularioContratoParrafo = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoParrafo.Controller({
            //GrabarSuccess: base.Event.BtnBuscarClick
        });

        base.Control.DialogFormularioAdjunto = new Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Controller();
        ...
        base.Control.DlgFormularioMotivoEliminacion = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoEliminar.Controller({
            DespuesDeGrabar: base.Event.BtnBuscarClick
        });

        base.Control.DlgBuscarNumeroContrato = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.BuscarNumeroContrato.Controller({
            GrabarSuccess: base.Event.BtnBuscarClick
        });
    };
    ...
    base.Event = {
        ...
        BtnAgregarClick: function () {
            'use strict'
            base.Control.DlgFormularioContrato = new Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContrato.Controller({
                GrabarSuccess: base.Event.BtnBuscarClick
            });
        ...
        BtnEliminarClick: function () {
            ...
            if (selectedData.length < 1) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.EtiquetaTituloAdvertencia,
                ...
                base.Control.Mensaje.Confirmation({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.TituloEliminar,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.ConfirmacionEliminacionRegistros,
                    onAccept: function () {
        ...
        BtnGridViewEditValidate: function (data, type, full) {
            ...
            if (base.Control.ListadoContratoModel.ControlPermisos.ControlTotal || base.Control.ListadoContratoModel.ControlPermisos.Escritura) {
                if (full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.ListadoContrato.Mensajes.EstadoEdicionSolicitaAu ||
                    full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.ListadoContrato.Mensajes.EdicionRechazada ||
                    full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.ListadoContrato.Mensajes.RevisionRechazada
                    ) {
                    return true;
                } else {
                    return false;
        ...
        BtnGridEditContenidoContratoValidate: function (data, type, full) {
            ...
            if (base.Control.ListadoContratoModel.ControlPermisos.ControlTotal || base.Control.ListadoContratoModel.ControlPermisos.Escritura) {
                if (full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.CodigoEstadoEdicion.EdicionParcial) {
                    if (full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.ListadoContrato.Mensajes.EstadoEdicionSolicitaAu) {
                        return true;
                    }
                    else {
        ...
        BtnGridEditContenidoContratoHtmlValidate: function (data, type, full) {
            if (base.Control.ListadoContratoModel.ControlPermisos.ControlTotal || base.Control.ListadoContratoModel.ControlPermisos.Escritura) {
                if (full.CodigoEstadoEdicion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.CodigoEstadoEdicion.EdicionParcial && full.EsFlexible == true) {
                    return true;
                }
                else {
                    return false;
        ...
        BtnGridDeleteValidate: function (data, type, full) {
            if (base.Control.ListadoContratoModel.ControlPermisos.ControlTotal) {
                if (full.CodigoEstadoContrato == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.EstadoContrato.Edicion || full.CodigoEstadoContrato == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.EstadoContrato.Aprobacion) {
                    return true;
                }
                else {
                    return false;
        ...
        BtnGridResueltoValidate: function (data, type, full) {
            if (base.Control.ListadoContratoModel.ControlPermisos.ControlTotal) {
                if (full.ValidacionResolucion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.TipoValidacionContratoResolucion.Cumple_Carga || full.ValidacionResolucion == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.TipoValidacionContratoResolucion.Cargado_Modo_Lectura) {
                    return true;
                }
                else {
                    return false;
        ...
        BtnGridDeleteClick: function (row, data) {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.TituloEliminar,
                message: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.ConfirmacionEliminacionRegistro,
                onAccept: function () {
        ...
        BtnGridPdfClick: function (row, data) {
            ...
            Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.MostrarContratoDocumento, vrParam);
        },
        ...
        BtnGridVisualizarClick: function (row, data) {
            'use strict'
            Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.FormularioContratoFlexibleEditar, {
                codigoContrato: data.CodigoContrato
            });
        }
    };
    ...
    base.Ajax = {
        AjaxEliminar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.EliminarContrato,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                ...
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridNombreUnidadOperativa,
                width: "20%"
            });
            columns.push({
                data: 'Descripcion',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridDescripcion,
                width: "20%"
            });
            columns.push({
                data: 'NumeroRequerimiento',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridNumeroContrato,
                width: "15%"
            });
            ...
            columns.push({
                data: 'MontoRequerimientoString',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridMontoContrato,
                width: "20%"
            });
  
            columns.push({
                data: 'FechaInicioVigenciaString',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridFechaInicio,
                width: "10%"
            });
            columns.push({
                data: 'FechaFinVigenciaString',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridFechaFin,
                width: "10%"
            });
  
            columns.push({
                data: 'DescripcionTipoDocumento',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridTipoDocumento,
                width: "15%"
            });
            columns.push({
                data: 'DescripcionEstadoContrato',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridEstadoContrato,
                width: "15%"
            });
            
            columns.push({
                data: 'FechaCreacionString',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridFechaCreacion,
                width: "10%"
            });
            columns.push({
                data: 'UsuarioCreacion',
                title: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridUsuarioCreacion,
                width: "10%"
            });
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Resources.GridAcciones,
                "class": "controls",
                width: "5%",
                actionButtons: [
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                //    { aTargets: [0, 3,4, 7, 21], orderable: false }
                //],
                hasPagingServer: true,
                ordering: true,
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.BuscarContrato,
                    source: 'Result'
                },
