...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoEliminar');

Pe.Stracon.SGC.Presentacion.Contractual.ListadoRequerimiento.FormularioContratoEliminar.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
