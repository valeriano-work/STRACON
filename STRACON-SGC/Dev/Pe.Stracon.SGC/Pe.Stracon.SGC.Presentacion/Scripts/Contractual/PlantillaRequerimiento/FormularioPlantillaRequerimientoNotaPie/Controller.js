...
/// </remarks>
ns('Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Index');
Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Index.Controller = function (opts) {
    var base = this;
    ...
    base.Event = {
        ...
        BtnCancelarClick: function () {
            'use strict'
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Actions.PlantillaNotaPie + "?codigoPlantilla=" + base.Control.HdnCodigoPlantilla().val();
        },      
        ...
        AjaxGrabarSuccess: function (data) {
            ...
            window.location.href = Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Actions.PlantillaNotaPie + "?codigoPlantilla=" + data.Result.CodigoPlantilla;
        },
        ...
        BtnGrabarClick: function () {
            if (base.Control.SpnFrmOrden().val() == 0 || base.Control.SpnFrmOrden().val() == "" || base.Control.SpnFrmOrden().val() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Resources.EtiquetaFormularioPlantillaNotaPie,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Mensajes.MsjValidaOrdenParrafo
                });
                return;
            }
            ...
            if (base.Control.TxtFrmTitulo().val().replace(/\s+/g, '') == "" || base.Control.TxtFrmTitulo().val() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Resources.EtiquetaFormularioPlantillaNotaPie,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Mensajes.MsjValidaTituloParrafo
                });
                return;
            }
            ...
            if (EditorContenido.getData() == "" || EditorContenido.getData() == null) {
                base.Control.Mensaje.Warning({
                    title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Resources.EtiquetaFormularioPlantillaNotaPie,
                    message: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Mensajes.MsjValidaContenidoParrafo
                });
                return;
            }

            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Resources.EtiquetaTituloConfirmar,
    ...
    base.Ajax = {
        AjaxGrabar: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.PlantillaRequerimiento.FormularioPlantillaRequerimientoNotaPie.Actions.RegistrarNotaPie,
            autoSubmit: false,
