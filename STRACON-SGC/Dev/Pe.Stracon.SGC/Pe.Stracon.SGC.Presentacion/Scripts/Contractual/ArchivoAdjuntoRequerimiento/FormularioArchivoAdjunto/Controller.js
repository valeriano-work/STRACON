ns('Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento');

Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Controller = function (opts) {
    var base = this;
    base.Ini = function () {
        base.Control.Modelo = Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Models.FormularioCargaAdjuntoContrato;
    ...
    base.Show = function (data) {
        ...
        base.Control.DialogFormularioCarga.getAjaxContent({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.FormularioCargaAdjunto,
            data: {
    ...
    base.Event = {
        ...
        BtnGridDeleteClick: function (row, data) {
            ...
            base.Control.Mensaje.Confirmation({
                title: Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Resources.TituloEliminar,
                message: Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Resources.ConfirmacionEliminacionRegistro,
                onAccept: function () {
        ...
        BtnGridDescargarClick: function (row, data) {
            ...
            Pe.GMD.UI.Web.Components.Util.RedirectPost(Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.DescargarArchivoAdjunto, vrParam);
        },
        ...
        BtnGridDeleteAdjuntoValidate: function (data, type, full) {
            if (base.Control.Modelo.ControlPermisos.ControlTotal) {
                if (full.UsuarioCreacion.toLowerCase() == base.Control.Modelo.UsuarioSession.toLowerCase() && (base.Control.Modelo.Contrato.CodigoEstadoContrato == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.EstadoContrato.Edicion) || (base.Control.Modelo.Contrato.CodigoEstadoContrato == Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Enumerados.EstadoContrato.Aprobacion)) {
                    return true;
                }
                else {
                    return false;
    ...
    base.Ajax = {
        AjaxGrabarDocumentoAdjunto: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.RegistrarArchivoAdjunto,
            hasFile: true,
            autoSubmit: false,
            contentType: false,
            processData: false,
        ...
        AjaxEliminarDocumentoAdjunto: new Pe.GMD.UI.Web.Components.Ajax({
            action: Pe.Stracon.SGC.Presentacion.Contractual.Requerimiento.Actions.EliminarArchivoAdjunto,
            autoSubmit: false,
    ...
    base.Function = {
        CrearGrid: function () {
            ...
            columns.push({
                data: 'NombreArchivo',
                title: Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Resources.GridNombreArchivo,
                width: "90%"
            });
            columns.push({
                "data": "", "title": Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Resources.GridAcciones,
                "class": "controls",
                width: "10%",
                actionButtons: [
            ...
            base.Control.GrdResultado = new Pe.GMD.UI.Web.Components.Grid({
                ...
                proxy: {
                    url: Pe.Stracon.SGC.Presentacion.Contractual.ArchivoAdjuntoRequerimiento.Actions.BuscarArchivoAdjunto,
                    source: 'Result'
                }
            });
        }
