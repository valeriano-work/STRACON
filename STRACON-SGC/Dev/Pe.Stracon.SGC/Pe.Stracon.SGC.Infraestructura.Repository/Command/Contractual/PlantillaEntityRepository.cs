...
namespace Pe.Stracon.SGC.Infraestructura.Repository.Command.Contractual
{
    ...
    public class PlantillaEntityRepository : ComandRepository<PlantillaEntity>, IPlantillaEntityRepository
    {
        ...
        /// <returns></returns>
        public int CopiarPlantilla(Guid codigoPlantillaCopiar, string descripcion, string codigoTipoContrato, string codigoTipoDocumento, DateTime fechaInicioVigencia, string usuarioCreacion, string terminalCreacion, bool esmayormenor)
        {
            SqlParameter[] parametros = new SqlParameter[]
            {
                ...
                new SqlParameter("ES_MAYORMENOR",SqlDbType.Bit) { Value = (object)esmayormenor ?? DBNull.Value}
            };
