...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.ReporteListadoContratoRegularizado
{
    /// <summary>
    ...
    /// Modificación:                </br>
    /// </remarks>
    public class ReporteListadoContratoRegularizadoBusqueda : GenericViewModel
    {
         /// <summary>
        ...
        public ReporteListadoContratoRegularizadoBusqueda(List<UnidadOperativaResponse> unidadOperativa, List<CodigoValorResponse> tipoServicio, List<CodigoValorResponse> tipoRequerimiento, List<CodigoValorResponse> tipoDocumento, List<CodigoValorResponse> estadoContrato, ReporteListadoContratoRegularizadoResponse reporteListadoContratoRegularizado)
        {
            this.UnidadOperativa = this.GenerarListadoOpcionUnidadOperativaFiltro(unidadOperativa, reporteListadoContratoRegularizado.CodigoUnidadOperativa);
            ...
            this.ReporteListadoContratoRegularizado = reporteListadoContratoRegularizado;
        ...
        public ReporteListadoContratoRegularizadoResponse ReporteListadoContratoRegularizado { get; set; }
