...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.VariablePlantillaRequerimiento
{
    ...
    /// Modificación:   
    /// </remarks>
    public class VariablePlantillaRequerimientoBusqueda : GenericViewModel
    {
        /// <summary>
        ...
        public VariablePlantillaRequerimientoBusqueda(List<PlantillaRequerimientoResponse> plantilla, List<CodigoValorResponse> tipoVariable)
        {
