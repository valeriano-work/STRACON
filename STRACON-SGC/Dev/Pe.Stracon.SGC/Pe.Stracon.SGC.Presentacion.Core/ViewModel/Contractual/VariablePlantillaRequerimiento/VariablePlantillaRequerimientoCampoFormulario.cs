...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.VariablePlantillaRequerimiento
{
    ...
    /// Modificación:   
    /// </remarks>
    public class VariablePlantillaRequerimientoCampoFormulario : GenericViewModel
    {
        #region Propiedades
        /// <summary>
        /// Campos de Variable
        ...
        /// </summary>
        public VariablePlantillaRequerimientoCampoFormulario(string codigoVariable, List<CodigoValorResponse> listaTipoAlineamiento)
        {
        ...
        /// Constructor de la Clase
        /// </summary>
        public VariablePlantillaRequerimientoCampoFormulario(VariableCampoResponse variableCampoResponse, List<CodigoValorResponse> listaTipoAlineamiento)
        {
