...
namespace Pe.Stracon.SGC.Presentacion.Core.ViewModel.Contractual.VariablePlantilla
{
    ...
    /// Modificación:   
    /// </remarks>
    public class VariablePlantillaFormulario : GenericViewModel
    {
        /// <summary>
        ...
        public VariablePlantillaFormulario(List<PlantillaResponse> plantilla, List<CodigoValorResponse> tipoVariable)
        {
        ...
        /// <param name="tipoVariable">Tipo Variable</param>
        public VariablePlantillaFormulario(List<PlantillaResponse> plantilla, VariableResponse variable, List<CodigoValorResponse> tipoVariable)
        {
            var listaPlantilla = plantilla.Select(x => new CodigoValorResponse() { Codigo = x.CodigoPlantilla, Valor = x.Descripcion }).ToList();
